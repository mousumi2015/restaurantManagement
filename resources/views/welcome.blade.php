    ...
    <div class="container-fluid color-bg">
        <div class="row dis-table">
            ...
            <div class="col-xs-6 col-sm-6 dis-table-cell">
                <div class="section-content">
                    <p>Jamal Khan Road,Concord Plaza (4th floar), Chittagong.</p>
                    <p>+01820-420420</p>
                    <p>mousumi.cse05@gmail.com </p>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <div class="copyright text-center">
                    <p>
                        &copy; Copyright, 2018 <a href="#">Mousumi.</a> Developed by <a href="https://mousumi2015.github.io/">Mousumi Biswas</a>  
                    </p>
                </div>
            </div>
        </div>
